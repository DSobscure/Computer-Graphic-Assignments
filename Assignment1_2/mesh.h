...
class mesh  
{
	...
	void	LoadMtl(std::string fileDirectory, std::string tex_file);
...
public:
	...
	void	LoadMesh(std::string fileDirectory, std::string scene_file);
	
	mesh();
	mesh(std::string fileDirectory, std::string obj_file);
	virtual ~mesh();

	void Init(std::string fileDirectory,  std::string obj_file);
